 ...
 * Also reject non-JSON responses (e.g. HTML error pages from proxy when backend is down).
 */
apiClient.interceptors.response.use(
  (response) => {
    // Reject HTML responses (proxy error pages when backend service is down)
