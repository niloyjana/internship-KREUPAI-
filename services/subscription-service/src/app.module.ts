...
@Module({
  imports: [
    ...
    // Authentication module (JWT validation only — no token issuing)
    AuthModule,
    ...
    KafkaModule.register({
      ...
      consumerGroupId: 'subscription-service-group',
    }),

    // Subscription domain module
    SubscriptionsModule,

    // Entitlements — subscription checks and usage quota enforcement
    EntitlementsModule,

    // Stripe webhooks — handles payment and subscription lifecycle events
    WebhooksModule,
